...
public class UserController {
    ...
    @ResponseBody
    public ResponseEntity<Result> getPhoneNumber(@RequestParam("sessionKey")String sessionKey,@RequestParam("ivCode")String ivCode,@RequestParam("encrypData")String encrypData) throws Exception {

        Map<String, Object> result = new HashMap<>();
        result.put("items",userBlService.getPhoneNumber(sessionKey,ivCode,encrypData));
        return new ResponseEntity<>(ResultGenerator.genSuccessResult(result),HttpStatus.OK);
    }
}
