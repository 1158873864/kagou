...
public class AESDecodeUtils {
    public static String decrypt(String sessionKey, String ivCode, String encrypData) throws Exception {
        ...
        String result=new String(cipher.doFinal(Base64.decodeBase64(encrypData)), "UTF-8");
        System.out.println("!!!");
        System.out.println(result);
        //解析解密后的字符串
        return (String) JSONObject.fromObject(result).get("phoneNumber");
    }
}
