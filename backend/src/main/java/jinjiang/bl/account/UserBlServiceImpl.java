...
import jinjiang.util.AESDecodeUtils;
...
//			}
	...
	@Override
	public String getPhoneNumber(String sessionKey, String ivCode, String encrypData) throws Exception {
		return AESDecodeUtils.decrypt(sessionKey,ivCode,encrypData);
	}
