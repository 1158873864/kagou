...
public class User {
    ...
    private String identity; //用户身份，可分为 member(会员)、staff(员工)、shareholder(股东)、manager(庄主)
    ...
    @Column(name = "level")
    private String level;//用户等级ID，只是针对会员身份的人群

    @Column(name= "balance")
    private double balance;//余额

    @Column(name= "takeBalance")
    private double takeBalance;//提现账户，提现账户只有股东和庄主身份的人拥有

    @Column(name= "integral")
    private int integral;//积

    @Column(name = "regtime")
    private String regtime; //注册时间

    @Column(name = "shopId")
    private String shopId; //所属商户的id
